...
//taken from https://github.com/weirdgloop/osrs-dps-calc/blob/staging/src/lib/EquipmentAliases.ts
//could also make use of https://github.com/weirdgloop/osrs-dps-calc/blob/staging/scripts/generateEquipmentAliases.py to generate
var equipmentAliases = map[int][]int{
	...
	25865: {25867, 25896, 25890, 25892, 25886, 25884, 25894, 25888}, // Bow of faerdhinen (c) -- manuel edit for normal bowfa
	...
	27251: {27253},                                                  // Elidinis' ward -- manual edit, wiki generate script have bug for this item
	...
	11865: {
		...
		25191, 26684, 25912, 25914, 26682, 25900, 25902, 26683, 25906, 25908}, // Slayer helmet (i)#Nightmare Zone
...
func getIdAlias(itemId int) int {
	for aliasId, ids := range equipmentAliases {
