...
export const changeLogData: logData[] = [
  ...
  { title: '26 June 2024', body: ['Moved result graphs in a tab view'] },
  { title: '12 June 2024', body: ['Added changelog', 'Added wiki dps setup button'] },
  { title: '10 June 2024', body: ['Added most combat rebalance changes'] },
];
